...
const requireCustomerData=(req: Request, res: Response, next: NextFunction)=>process.env.CUSTOMER_DATA_ENABLED==='true'?next():res.status(404).json({error:'Customer data is disabled'});
